...
class DataBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([__DIR__.'/../config/ore.data-builder.php' => config_path('ore.data-builder.php')], 'config');

        $this->loadMigrationsFrom(__DIR__.'/../database/migrations');
        $this->loadRoutes();

        config(['ore.managers' => array_merge(Config::get('ore.managers', []), [
            \Railken\LaraOre\DataBuilder\DataBuilderManager::class,
        ])]);
    }
    ...
    {
        $config = Config::get('ore.data-builder.http.admin');
